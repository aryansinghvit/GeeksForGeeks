<h2><a href="https://www.geeksforgeeks.org/problems/toeplitz-matrix/1?_gl=1*1hhqpv8*_up*MQ..&gclid=CjwKCAjw4ufOBhBkEiwAfuC7-XRK0yNMpoP9bevtsWY3V-Tp_-iEOkExAwsi8zjulA-zQyjzOVH_XBoCCvEQAvD_BwE&gbraid=0AAAAAC9yBkC71u75kn9xt6imWoxcmG8Lv">Toeplitz matrix</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">A <strong>Toeplitz matrix</strong> (also known as a diagonal-constant matrix) is a matrix in which every descending diagonal from left to right contains the same element.</span></p>
